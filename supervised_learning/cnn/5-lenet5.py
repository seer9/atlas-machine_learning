...
def lenet5(X):
    ...
    conv1 = K.layers.Conv2D(
        ...
        kernel_initializer=K.initializers.he_normal(seed=None))(X)
    ...
    conv2 = K.layers.Conv2D(
        ...
        kernel_initializer=K.initializers.he_normal(seed=None))(pool1)
    ...
    fc1 = K.layers.Dense(units=120, activation='relu',
                         kernel_initializer=K.initializers.he_normal(seed=None))(flatten)
    fc2 = K.layers.Dense(units=84, activation='relu',
                         kernel_initializer=K.initializers.he_normal(seed=None))(fc1)
    fc3 = K.layers.Dense(units=10,
                         kernel_initializer=K.initializers.he_normal(seed=None))(fc2)
